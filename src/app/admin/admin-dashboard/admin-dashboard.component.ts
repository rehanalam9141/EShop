...
export class AdminDashboardComponent implements OnInit {
  ...
  adminUserDashboardData(){
    this.adminService.user_DashboardData().subscribe(data => {
  ...
  adminProducDashboardData(){
    this.adminService.product_DashboardData().subscribe(data=>{
